...
north_cons = dfNorth['Constellations']
south_cons = dfSouth['Constellations']

north_dates = dfNorth['Dates']
south_dates = dfSouth['Dates']
...
for key, value in new_constellation_north.items():
	...
	#create the path to the updated activity guide
        ...
        working_doc = open_word_doc(r"C:\Users\Marco Moreno\OneDrive\Documentos\Enciso Systems\GaN\GaN\docs_to_change\GaN2018_ActivityGuide_Perseus_N_" + str(language) + ".docx")  
