            ...
            if constellation in paragraph.text:
                if North_date_replacement[language] in paragraph.text:
                    ...
                    if language in CountryList1:
                        ...
                        paragraph.add_run(North_heading_first[language] + str(date) + North_heading_middle[language] + str(constellation) + North_heading_last[language], style = 'GaNStyle')
                        
                    elif language in CountryList2:
                    
                        paragraph.add_run(North_heading_first[language] + str(constellation) + North_heading_middle[language] + str(year) + North_heading_last[language] + str(date) + ".", style = 'GaNStyle')
                    
                    elif language in CountryList3:
                    
                        if language != "Thai":
                            paragraph.add_run(North_heading_first[language] + str(year) + North_heading_middle[language] + str(constellation) + North_heading_last[language] + str(date) + ".", style = 'GaNStyle')
                        else:
                            paragraph.add_run(North_heading_first[language] + str(Thai_year) + North_heading_middle[language] + str(constellation) + North_heading_last[language] + str(date) + ".", style = 'GaNStyle')        
